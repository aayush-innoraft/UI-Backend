 ...
 *     "add-form" = "/admin/config/movies/add",
 *     "canonical" = "/admin/config/movies/{movie}",
 *     "edit-form" = "/admin/config/movies/{movie}/edit",
 *     "delete-form" = "/admin/config/movies/{movie}/delete",
